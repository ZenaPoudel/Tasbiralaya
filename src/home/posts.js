...
import { View,Alert, Image,Text,ScrollView,AsyncStorage} from 'react-native';
    ...
    componentDidMount() {
       AsyncStorage.getItem("username").then((value) => {
        ...
        AsyncStorage.getItem("token").then((value) => {
         ...
         AsyncStorage.getItem("id").then((value) => {
          ...
          AsyncStorage.getItem("fn").then((value) => {
       ...
       if(this.state.id!=='' && this.state.token!==""){
           ...
           axios({
            ...
            url: 'http:// 192.168.100.88/app/getPost',
        ...
        return(
            <View style={{marginTop:15,borderBottomWidth:1,borderBottomColor:'rgba(0,0,0,0.1)',paddingBottom:10}}>
                ...
                <View style={{marginTop:10,flex:1,marginLeft:10,flexDirection:'row'}}>
                    ...
                    <TouchableHighlight onPress={this.likefun } >
                    <Image
