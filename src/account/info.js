...
import {View, Text, ScrollView, Image, TouchableHighlight, ViewPagerAndroid, AsyncStorage} from 'react-native';
...
export default class Info extends Component{
    ...
    componentDidMount() {
        AsyncStorage.setItem("id", "http://192.168.0.150:8000");
    }
    render(){
        return(
            <ViewPagerAndroid
    ...
    <View style={{height:10, width:10, borderRadius:10, backgroundColor:'white', marginLeft:10}}>
                    ...
                    <TouchableHighlight onPress={()=>this.props.navigation.navigate('Signup')} style={{alignItems:'center',width:'100%',paddingTop:10,paddingBottom:10,marginTop:20,borderRadius:25,backgroundColor:'#22addc'}}>
